...
define([
  ...
  var DO_NOT_PERSIST = ['channel', 'prefillPassword', 'error', 'language', 'service'];
  ...
  var PERSIST_TO_LOCAL_STORAGE = ['email', 'sessionToken', 'sessionTokenContext', 'oauth', 'recoveryPayload'];
